...
export const mockEvents: Event[] = [
  { id: 'e1', organizationId: 'org1', title: 'Réunion budget annuel', description: 'Présentation et validation du budget prévisionnel 2026.', startAt: new Date(Date.now() + 1000 * 60 * 60 * 24 * 3 + 1000 * 60 * 60 * 10).toISOString(), endAt: new Date(Date.now() + 1000 * 60 * 60 * 24 * 3 + 1000 * 60 * 60 * 12).toISOString(), participants: ['u1', 'u2', 'u3'], createdById: 'u2', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24).toISOString(), status: 'scheduled' },
  { id: 'e2', organizationId: 'org1', title: 'Entretiens annuels RH', description: "Cycle d'entretiens individuels avec les équipes.", startAt: new Date(Date.now() + 1000 * 60 * 60 * 24 * 7).toISOString(), endAt: new Date(Date.now() + 1000 * 60 * 60 * 24 * 9).toISOString(), participants: ['u1', 'u5'], createdById: 'u1', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2).toISOString(), status: 'scheduled' },
  { id: 'e3', organizationId: 'org1', title: 'Comité de direction', startAt: new Date(Date.now() + 1000 * 60 * 60 * 24 * 14 + 1000 * 60 * 60 * 9).toISOString(), endAt: new Date(Date.now() + 1000 * 60 * 60 * 24 * 14 + 1000 * 60 * 60 * 11).toISOString(), participants: ['u1', 'u2', 'u3', 'u4'], createdById: 'u2', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 3).toISOString(), status: 'modified', modifiedAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString(), description: 'Horaire décalé à 9h (était 10h).' },
  { id: 'e4', organizationId: 'org1', title: 'Réunion partenaires externes', startAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2).toISOString(), endAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2 + 1000 * 60 * 90).toISOString(), participants: ['u2', 'u7'], createdById: 'u2', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 4).toISOString(), status: 'done' },
  { id: 'e5', organizationId: 'org1', title: 'Formation sécurité incendie', startAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 5).toISOString(), endAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 5 + 1000 * 60 * 120).toISOString(), participants: ['u1', 'u2', 'u3', 'u4', 'u5'], createdById: 'u6', createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 6).toISOString(), status: 'cancelled', cancelReason: 'Formateur indisponible — reporté.' },
]
